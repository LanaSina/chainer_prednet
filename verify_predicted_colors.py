...
# colors = predicted colors, col_image = actual colors
...
# col_image_dir = directory with original color images used as input
# gs_image_dir = directory with original greyscale images used as input
def process_images(image_dir, col_image_dir, gs_image_dir, image_count, output_dir, start):
	# loop on images
	image_list = sorted(os.listdir(image_dir))
	gs_image_list = sorted(os.listdir(gs_image_dir))
	col_image_list = sorted(os.listdir(col_image_dir))
...
process_images(args.image_dir, args.col_image_dir, args.gs_image_dir, args.n_images, args.output_dir, args.start)
