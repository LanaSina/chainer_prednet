...
```
```{r}
 filename = "graded_lines5_mit.csv"
...
```{r}
plot(df$r, type="l", ylim = c(100,250), col = "red"
     , main = "rgb averages", ylab = "rgb", xlab = "frame")
#points(df$g, type = "l", col = "green")
points(df$b, type = "l", col = "blue")

# points(dfi$r, type = "l", col = "red")
# #points(dfi$g, type = "l", col = "green")
# points(dfi$b, type = "l", col = "blue")


# plot(dfi$r-df$r, type="l", col = "red",ylim = c(-20,50) 
#      , main = "rgb diff", ylab = "rgb", xlab = "frame")
# points(dfi$g - df$g, type = "l", col = "green")
# points(dfi$b - df$b, type = "l", col = "blue")


plot(df$b-df$r, type="l", col = "purple", ylim = c(-10,10) 
     , main = "(blue-red)", ylab = "rgb", xlab = "frame")
