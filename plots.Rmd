...
plot(df$wb_r, col = "red", type = "l",
     main = "Colored flickers: white, black, ...", ylim = c(0,ymax)
    )
...
```{r}
filename = "black_white_next/bike_4h_sample.csv"
df = read.csv(paste(dataFolder,filename,sep = ""), check.names = FALSE)

plot(df$r, col = "red", type = "l",
     main = "sky rgb", ylim = c(0,255)
    )
